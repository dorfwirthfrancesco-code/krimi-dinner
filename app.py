...
LS_VARIANTS = {
    ...
    'pitch':   _clean_id(os.environ.get('LS_VARIANT_PITCH', '')),
}
...
def shop():
    ...
    items = [
        ...
        {'id': 'alpina',  'name': 'Das Grand Hotel Alpina',  'genre': t['genre_classic'],    'players': '4–11', 'duration': '90–120 min', 'price': '4.99', 'tag': ''},
        {'id': 'pitch',   'name': 'Der finale Pitch',        'genre': t['genre_classic'],    'players': '4–11', 'duration': '90–120 min', 'price': '4.99', 'tag': 'New'},
    ]
    for item in items:
